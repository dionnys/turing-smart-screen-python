...
try:
    ...
    print(
        "[ERROR] Tkinter dependency not installed. Please follow troubleshooting page: https://github.com/dionnys/turing-smart-screen-python/wiki/Troubleshooting#all-os-tkinter-dependency-not-installed")
    try:
        sys.exit(0)
    except:
        os._exit(0)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        viewer = tkinter.Tk()
        viewer.title("Turing Smart Screen Theme Editor")
